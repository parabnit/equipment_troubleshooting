        ...
        <!-- Daily Tasks -->
            ...
            <div class="collapse <?= ($currentPage == 'daily_tasks.php') ? 'show' : ''; ?>"
                ...
                <?php } if(is_LabManager($_SESSION['memberid']) || is_AssistLabManager($_SESSION['memberid']) || is_PI($_SESSION['memberid']) ||    is_FOC_member($_SESSION['memberid']) || is_FacilityHead($_SESSION['memberid']) || is_FacilityTeam($_SESSION['memberid']) ){?>
                    ...
                    <!-- Added Training -->
                    <?php if(is_LabManager($_SESSION['memberid']) || is_AssistLabManager($_SESSION['memberid']) || is_PI($_SESSION['memberid']) ||is_TrainingHead($_SESSION['memberid']) || is_TrainingTeam($_SESSION['memberid']) ){ ?>
